...
class CupsClient:
    ...
    def get_jobs(
        ...
        self.ensure_connected()
        try:
            # pycups getJobs() returns only a minimal attribute set by default
            # (no timestamps, sometimes no job-name or username for completed jobs).
            # Request all fields the UI needs explicitly.
